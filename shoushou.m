...
DATAVEL(1).data = DATA1;
DATADISP(1).data = DATA2;
DATAACC(1).data = DATA3;
%%
% 读取2015年地震速度、位移、加速度数据的SAC文件2023.5.7.19:14
% 读取速度文件
maindir1 = 'C:\Users\wty\Downloads\百度网盘下载\SAMSUNG28地震_SAC\SAMSUNG-vel';
subdir1 = dir(maindir1);
subdirpath1 = fullfile(maindir1, subdir1(4).name, '*.SAC');  % 注意前两个subdir去掉'.','..'
stru1 = dir(subdirpath1);
DATA1 = struct();
% 读取位移文件
maindir2 = 'C:\Users\wty\Downloads\百度网盘下载\SAMSUNG28地震_SAC\SAMSUNG-disp';
subdir2 = dir(maindir2);
subdirpath2 = fullfile(maindir2, subdir2(4).name, '*.SAC');  % 注意前两个subdir去掉'.','..'
stru2 = dir(subdirpath2);
DATA2 = struct();
% 读取加速度文件
maindir3 = 'C:\Users\wty\Downloads\百度网盘下载\SAMSUNG28地震_SAC\SAMSUNG - acc';
subdir3 = dir(maindir3);
subdirpath3 = fullfile(maindir3, subdir3(4).name, '*.SAC');  % 注意前两个subdir去掉'.','..'
stru3 = dir(subdirpath3);
DATA3 = struct();
number = 0;
% 
...
DATAVEL(2).data = DATA1;
DATADISP(2).data = DATA2;
DATAACC(2).data = DATA3;
%% 读取2014年SEED文件
